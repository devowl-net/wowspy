...
namespace WowDotNetAPI
{
    ...
    public class WowExplorer : IExplorer
    {
        ...
        public Leaderboard GetLeaderBoards(Bracket bracket)
        {
            ...
            TryGetData(
                string.Format(@"{0}/wow/leaderboard/{1}?locale={2}&apikey={3}", Host,
                    bracket.ToString().Replace("_", ""), Locale, APIKey),
                out pvpRows);
        ...
        public IEnumerable<Mount> GetMounts()
        {
            ...
            TryGetData(string.Format(@"{0}/wow/mount/?locale={1}&apikey={2}", Host, Locale, APIKey),
                out mounts);
        ...
        public IEnumerable<Pet> GetPets()
        {
            ...
            TryGetData(string.Format(@"{0}/wow/pet/?locale={1}&apikey={2}", Host, Locale, APIKey),
                out pets);
        ...
        public PetAbilityDetails GetPetAbilityDetails(int id)
        {
            ...
            TryGetData(string.Format(@"{0}/wow/pet/ability/{1}?locale={2}&apikey={3}", Host, id, Locale, APIKey),
                out ability);
        ...
        public PetSpecies GetPetSpeciesDetails(int id)
        {
            ...
            TryGetData(string.Format(@"{0}/wow/pet/species/{1}?locale={2}&apikey={3}", Host, id, Locale, APIKey),
                out species);
        ...
        public PetStats GetPetStats(int speciesId, int level, int breedId, int qualityId)
        {
            ...
            TryGetData(
                string.Format(@"{0}/wow/pet/stats/{1}?level={2}&breedId={3}&qualityId={4}&locale={5}&apikey={6}", Host,
                    speciesId, level, breedId, qualityId, Locale, APIKey),
                out stats);
        ...
        public IEnumerable<PetType> GetPetTypes()
        {
            ...
            TryGetData(string.Format(@"{0}/wow/data/pet/types?locale={1}&apikey={2}", Host, Locale, APIKey),
                out types);
        ...
        public IEnumerable<Realm> GetRealms(Locale locale)
        {
            ...
            return locale == Locale.None
                ? realmsData.Realms
                : realmsData.Realms.Where(x => x.Locale == locale.ToString());
        }
